...
public enum HttpStatusCode {
	 ...
	 CONTINUE(100, "Continue"),
	    ...
	    ALREADY_ROLE_EXISTS(208, "Already Role Exists"),
	    ...
	    DELETED_SUCCESSFULLY(209, "Deleted Successfully"),
	    UPDATED(210,"Updated Successfully"),
	    COMPLETED(210,"COMPLETED"),
	    PENDING(210,"PENDING"),
	    NOT_YET_STARTED(210,"NOT YET STARTED"),
	    ...
	    TOKEN_INVALID (497,"Token is invalid"),
	...
	public ResponseVO getResponseVO(String statusDec) {
		System.out.println("Status Code is :: "+this.code);
		responseVO = new ResponseVO();
		responseVO.setStatus(this.desc);
		responseVO.setStatusCode(this.code);
		responseVO.setStatusDesc(statusDec);
		return responseVO;
	}
}
